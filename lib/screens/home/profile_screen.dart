...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    _loadUserData(); // Panggil untuk memuat data saat init
  }
  ...
  Future<void> _loadUserData() async {
    ...
    if (mounted) {
      setState(() {
        // Data akan diisi dari SharedPreferences, tidak ada nilai statis
      });
    }
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          final position = userData['position'] ?? 'No Position';
          final faceRegistered = userData['faceRegistered'] ?? false;
